...
const fetchMovieTrailer = async () => {
  ...
  const officalTrailer = trailers.filter((trailer) => trailer.name === "Official Trailer")[0];
  modal.innerHTML += `
  <iframe
  id="iframe"
  src="https://www.youtube.com/embed/${officalTrailer.key}?autoplay=1&mute=0&loop=1&playlist=${officalTrailer.key}"
